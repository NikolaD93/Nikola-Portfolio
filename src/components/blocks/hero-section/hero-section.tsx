    ...
    <section className='-mt-17.5 pt-17.5'>
      <div className='flex flex-col items-center space-y-4 px-4 py-16 text-center md:px-8'>
        <div className='relative mb-8 sm:mb-10'>
          {' '}
          <div className='from-primary-200 via-primary-200 to-primary-300 dark:from-primary-800/50 dark:via-primary-700/30 dark:to-primary-700/50 absolute -inset-0.5 rounded-full bg-linear-to-r opacity-70 blur-sm'></div>{' '}
          <div className='from-primary-300/20 via-primary-200/20 to-primary-200/20 dark:from-primary-700/20 dark:via-primary-700/10 dark:to-primary-800/20 animate-gradient-xy absolute inset-0 rounded-full bg-linear-to-r'></div>{' '}
          <div className='relative rounded-full p-0.5 backdrop-blur'>
            ...
            <div className='dark:bg-primary-950 relative z-10 overflow-hidden rounded-full'>
              ...
              />{' '}
              <div className='absolute inset-0 rounded-full bg-linear-to-b from-transparent to-black/10 opacity-40 dark:to-black/30'></div>{' '}
            </div>{' '}
          </div>
